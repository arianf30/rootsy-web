...
function defaultForm(): UpsertPopPrinterInput {
  return {
    name: "",
    isActive: true,
    sortOrder: 0,
...
function PrintersPage() {
  ...
  const submitCreate = async (e: FormEvent) => {
    ...
    setCreateBanner(null)
    const res = await createPopPrinter(popId, createForm)
  ...
  const submitEdit = async (e: FormEvent) => {
    ...
    setEditSaving(true)
    setEditBanner(null)
    const res = await updatePopPrinter(popId, editRow.id, editForm)
    setEditSaving(false)
    if (!res.success) {
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="max-w-xl text-sm text-muted-foreground">
                  Listado de impresoras para este local. La conexión con
                  extensión o app se definirá después; podés dejar tipo y datos
                  de conexión como referencia.
                </p>
              </div>
        ...
        >
          ...
          <form className="space-y-4" onSubmit={(e) => void submitCreate(e)}>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="pr-active" className="font-normal">
                Activa
              </Label>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="pr-kind">Tipo de integración (opcional)</Label>
              <Input
                id="pr-kind"
                value={createForm.integrationKind}
                onChange={(e) =>
                  setCreateForm((f) => ({
                    ...f,
                ...
                placeholder="p. ej. extensión, bridge"
                className="bg-background"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="pr-hint">Conexión (opcional)</Label>
              <Input
                id="pr-hint"
                value={createForm.connectionHint}
                onChange={(e) =>
                  setCreateForm((f) => ({
                    ...f,
                ...
                placeholder="IP, nombre de impresora, etc."
                className="bg-background"
              />
            </div>
      ...
      <Dialog open={editRow !== null} onOpenChange={(o) => !o && setEditRow(null)}>
        ...
        >
          ...
          <form className="space-y-4" onSubmit={(e) => void submitEdit(e)}>
            <div className="space-y-2">
              <Label htmlFor="e-pr-name">Nombre</Label>
              <Input
                id="e-pr-name"
                value={editForm.name}
                onChange={(e) =>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="e-pr-active" className="font-normal">
                Activa
              </Label>
            </div>
            <div className="space-y-2">
              <Label htmlFor="e-pr-sort">Orden</Label>
              <Input
                id="e-pr-sort"
                type="number"
            ...
            <div className="space-y-2">
              <Label htmlFor="e-pr-kind">Tipo de integración (opcional)</Label>
              <Input
                id="e-pr-kind"
                value={editForm.integrationKind}
                onChange={(e) =>
                  setEditForm((f) => ({
                    ...f,
                    integrationKind: e.target.value,
            ...
            <div className="space-y-2">
              <Label htmlFor="e-pr-hint">Conexión (opcional)</Label>
              <Input
                id="e-pr-hint"
