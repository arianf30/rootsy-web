...
const RECOVERY_NEXT = "/recuperar-contrasena?paso=nueva"
  ...
  useEffect(() => {
    ...
    async function verify() {
      ...
      if (paso === "nueva") {
        ...
        if (!session) {
          setFatalMessage(
            "No hay una sesión activa. Solicitá un nuevo link desde recuperar contraseña.",
          )
          setPhase("fatal")
          return
        }
    ...
    return shell(
      <div className="space-y-4 pt-6">
        ...
        <Button asChild className="h-12 w-full">
          <Link href="/recuperar-contrasena">Volver a solicitar enlace</Link>
        </Button>
        <Link
          href="/login"
