...
function SelectTrigger({
  ...
  /** sm · compacto · default · h-9 · md · misma altura que input h-11 en grillas */
  size?: 'sm' | 'default' | 'md'
}) {
  return (
